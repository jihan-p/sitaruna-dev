                            ...
                            <div className="col-md-12">
                                <div className="border-top pt-5">
                                    <p>
                                        ...
                                        {/* === Tambahkan kontribusi Anda di bawah sini === */}
                                        <br/> {/* Opsional: Pindah baris */}
                                        Adapted and developed by <a href="https://t.me/jhanplv" target="_blank" >jipi</a> @RPL SMKN 2 Subang {/* Ganti dengan teks kontribusi Anda */}
                                        {/* Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. */}
                                    </p>
                                </div>
                            </div>
